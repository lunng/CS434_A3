...
def decision_tree_various_depth(x_train, y_train, x_test, y_test):
	...
	print("The depth that gives the best validation accuracy is: ", [item for item in range(1, 26)][graphF1.index(topAccuracy)], "which has an F1 accuracy of ", topAccuracy)
